...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/endmylifehahahahahahahahaha/vapevoidware/main/"..scripturl, true)
	end
end
			...
			if callback then
				...
				if not suc then
					...
					framebutton1.MouseButton1Click:connect(function()
						spawn(function()
							setclipboard("https://github.com/endmylifehahahahahahahahaha/vapevoidware/wiki/Turning-on-Highlights")
